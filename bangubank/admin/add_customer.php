<pre>
  <?php
    ...
    if ($_SERVER["REQUEST_METHOD"]  == "POST") {
      ...
      $validation->required('name', $name, "Please provide a name!");
      ...
      if (!$validation->hasErrors()) {
           ...
           $userManager = new UserManager($fileHandler, $validation);
       ...
       $validation->addError('auth_info', "There is error");
       var_dump($validation->getError('auth_info'));
      }
        ...
        <nav
          ...
          <div
            ...
            <div class="pt-2 pb-3 space-y-1">
              <a
                href="./customers.php"
                class="block px-3 py-2 texphpt-base font-medium text-white rounded-md hover:bg-sky-500 hover:bg-opacity-75"
                >Customers</a
              >
              <a
                href="./transactions.php"
