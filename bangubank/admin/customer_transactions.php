...
$customerFile = new FileHandler("../database/users.json");
$customers = $customerFile->loadData();
                  ...
                  <div
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                      ...
                      foreach ($transactions as $transaction) : 
                        if ($transaction['account'] == $user_email || $transaction['toAccount'] == $user_email) : 
                      ?>
                      ...
                      <tr>
                          ...
                          <td
                            class="whitespace-nowrap px-2 py-4 text-sm font-medium <?= $transaction['transitionType'] == "deposit" || ($transaction['toAccount'] == $user_email && $transaction['transitionType'] == 'transfer' ) ? "text-emerald-600" : "text-red-600"  ?> ">
                            <?= $transaction['transitionType'] == "deposit" || ($transaction['toAccount'] == $user_email && $transaction['transitionType'] == 'transfer' ) ? "+" : "-"  ?>$<?= $transaction['amount'] ?>
                          </td>
                          <td
