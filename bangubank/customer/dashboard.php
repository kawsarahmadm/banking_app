...
use App\Auth;
use App\FileHandler;
use App\BalanceManagement;

Auth::isNotLoggedIn();

$fileHandler = new FileHandler("../database/users.json");
$customers = $fileHandler->loadData();
...
$balance = new BalanceManagement($customer_email);
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                      ...
                      <tbody class="divide-y divide-gray-200 bg-white">
                        <?php foreach($transactions as $transaction) : 
                          if ($transaction["account"] == $_SESSION['email'] ):
                        ?>
                        <tr>
                          <td
                      ...
                      <tbody class="divide-y divide-gray-200 bg-white">
                        <?php foreach($transactions as $transaction) : 
                          if ( $transaction["toAccount"] == $_SESSION['email'] && $transaction["transitionType"] === "transfer"  ):
                        ?>
                        <tr>
                          <td
                            class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-800 sm:pl-0">
